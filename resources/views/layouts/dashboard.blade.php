            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-notification mr-25">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        ...
                        <li class="scrollable-container media-list">
                            ...
                            <div class="notify_msg_seen media d-flex align-items-start bg__shade" data-id="{{ $notify->id }}">
                                <a target="_blank" href="{{ route('user',$user_info->id) }}">
                                    <div class="media-left">
                                        <div class="avatar">
                                            <img src="{{ asset('uploads/images/users') }}/{{ $user_info->profile_photo_path }}" alt="avatar" width="32" height="32">
                                        </div>
                                    </div>
                                </a>
                                <a target="_blank" href="{{ route('item_details', $item_slug) }}">
                                    <div class="media-body">
                                        <p class="media-heading">{{ App\Models\User::find($notify->user_id)->name }}<span class="font-weight-bolder"> {{ $notify->message }} </span> </p><small class="notification-text"></small>
                                    </div>
                                </a>
                            </div>
                ...
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                        <a class="dropdown-item" href="{{ route('edit_profile', Auth::id()) }}"><i class="mr-50" data-feather="user"></i> Profile</a>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item @yield('itemReport')">
                    <a class="d-flex align-items-center" href="{{ route('ItemReport.index') }}">
                        ...
                        <span class="menu-title text-truncate" data-i18n="Email">{{ __('Reports') }}</span>
                    </a>
                </li>
                <li class="nav-item @yield('itemProblems')">
                    <a class="d-flex align-items-center" href="{{ route('ItemProblem.index') }}">
                        <i data-feather='refresh-ccw'></i>
                        <span class="menu-title text-truncate" data-i18n="Email">{{ __('Customer Problems') }}</span>
                    </a>
                </li>
                <li class="nav-item @yield('reportUsers')">
                    <a class="d-flex align-items-center" href="{{ route('user.report.index') }}">
                        <i data-feather='trello'></i>
                        <span class="menu-title text-truncate" data-i18n="Email">{{ __('User Reports') }}</span>
                    </a>
                </li>
