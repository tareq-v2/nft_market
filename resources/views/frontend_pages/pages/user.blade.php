        ...
        <div class="tab-content">
            ...
            <div class="dropdown mb-8 flex flex-wrap items-center justify-between">
                ...
                <div class="my-1 mr-2.5">
                  ...
                  >
                    <ul class="flex flex-col flex-wrap">
                      <li>
                        <a user_id={{ $user->id }} style="cursor:pointer"
                          class="filterByUser dropdown-item font-display dark:hover:bg-jacarta-600 hover:bg-jacarta-50 flex w-full items-center rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white" id="allItemsUser"
                        >
                          <span>All</span>
                          {{-- <svg
                            xmlns="http://www.w3.org/2000/svg"
                      ...
                      <li>
                        <a
                            ...
                            cat_id="{{ $cat->id }}"
                            user_id="{{ $user->id }}"
                            class="filterByUser dropdown-item font-display dark:hover:bg-jacarta-600 hover:bg-jacarta-50 flex w-full items-center rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white">
                            {{ $cat->name }}
                        </a>
                      </li>
                      @endforeach
              ...
              <div class="dropdown my-1 cursor-pointer">
                <div
                  ...
                  aria-expanded="false"
                >
                  <span class="font-display dropdown-toggle__text">Recently Added</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    width="24"
          ...
          <div class="tab-pane fade" id="activity" role="tabpanel" aria-labelledby="activity-tab">
            ...
            <div class="lg:flex">
              <!-- Records -->
              @php
                $creator = App\Models\Item::where('creator_id', $user->id)->get();
              @endphp
              ...
              <div class="mb-10 shrink-0 basis-8/12 space-y-5 lg:mb-0 lg:pr-10 like_div">
                   ...
                   @php
                    ...
                    class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl relative flex items-center border bg-white p-8 transition-shadow hover:shadow-lg">
                    <figure class="mr-5 self-start">
                        <img src="{{ asset('/uploads/items') }}/{{ $like->getItem->image }}" alt="avatar 2" class="rounded-2lg" loading="lazy" width="100"/>
                    </figure>
                    ...
                    <div>
                        ...
                        <span class="text-jacarta-500 mb-3 block text-sm">Liker: {{ $like->get_liker->name }} </span>
              ...
              <div class="mb-10 shrink-0 basis-8/12 space-y-5 lg:mb-0 lg:pr-10 report_div">
                    ...
                    @endphp
                        ...
                        <a
                        href="{{ route('item_details', $repo->getItem->slug) }}"
                        class="dark:bg-jacarta-700 dark:border-jacarta-700 border-jacarta-100 rounded-2.5xl relative flex items-center border bg-white p-8 transition-shadow hover:shadow-lg">
                        <figure class="mr-5 self-start">
                            <img src="{{ asset('/uploads/items') }}/{{ $repo->getItem->image }}" alt="avatar 2" class="rounded-2lg" loading="lazy" width="100"/>
                        </figure>
                        ...
                        <div>
                            ...
                            <span class="text-jacarta-500 mb-3 block text-sm">Reporter: {{ $repo->getUser->name }} </span>
                            <span class="text-jacarta-500 mb-3 block text-sm">Report: {{ $repo->getProblem->problem }} </span>
              ...
              <aside class="basis-4/12 lg:pl-5">
                ...
                <div class="flex flex-wrap">
                  ...
                  <button
                    class="bid_filter hover-color dark:border-jacarta-600 dark:bg-jacarta-700 group dark:hover:bg-accent hover:bg-accent border-jacarta-100 mr-2.5 mb-2.5 inline-flex items-center rounded-xl border bg-white px-4 py-3 hover:border-transparent hover:text-white dark:text-white dark:hover:border-transparent"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                  ...
                  <button
                    class="report_filter dark:border-jacarta-600 dark:bg-jacarta-700 group dark:hover:bg-accent hover:bg-accent border-jacarta-100 mr-2.5 mb-2.5 inline-flex items-center rounded-xl border bg-white px-4 py-3 hover:border-transparent hover:text-white dark:text-white dark:hover:border-transparent"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
