          ...
          <div class="mt-6 flex items-center justify-center space-x-2.5">
            ...
            >
              ...
              >
                ...
                <button
                  class="dark:hover:bg-jacarta-600 font-display hover:bg-jacarta-50 block w-full rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white copyURL"
                >
                  Share
                </button>
                @if (Auth::check())
            ...
            <div class="mb-8 flex flex-wrap items-center justify-between">
              ...
              <div class="dropdown my-1 cursor-pointer">
                ...
                >
                  ...
                  <button
                    class="dropdown-item font-display dark:hover:bg-jacarta-600 hover:bg-jacarta-50 flex w-full items-center justify-between rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white" id="RecentlyAddedCollection" category_id="{{ $nftcategory->id }}"
                  >
                    Recently Added
                    {{-- <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <button
                    class="dropdown-item font-display dark:hover:bg-jacarta-600 hover:bg-jacarta-50 flex w-full items-center justify-between rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white" id="LowToHighCollection" category_id="{{ $nftcategory->id }}"
                  >
                    Price: Low to High
                  </button>

                  <button
                    class="dropdown-item font-display dark:hover:bg-jacarta-600 hover:bg-jacarta-50 flex w-full items-center justify-between rounded-xl px-5 py-2 text-left text-sm transition-colors dark:text-white" id="HighToLowCollection" category_id="{{ $nftcategory->id }}"
                  >
                    Price: High to Low
                  </button>
              ...
              <div class="mb-10 shrink-0 basis-8/12 space-y-5 lg:mb-0 lg:pr-10">
                ...
                >
                  ...
                  <div>
                    ...
                    <span class="text-jacarta-500 mb-3 block text-sm">sold for 1.515 ETH</span>
