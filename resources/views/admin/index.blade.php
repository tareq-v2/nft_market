...
<section id="dashboard-analytics">
    ...
    <div class="row">
        ...
        {{-- <div class="col-xl-6 col-12 pb-0">
            <div class="card">
                <div class="card-header flex-column align-items-start">
                    <h4 class="card-title mb-75">Items Activity</h4>
                    <span class="card-subtitle text-muted">Statistic of Activity</span>
                </div>
                <div class="card-body">
                    <div id="itemActivityChart"></div>
                </div>
            </div>
        </div> --}}
    </div>
...
{{-- <script>
    var options = {
          series: [{
                ...
                name: 'All Like',
                data: @json($liked_items)
                }, {
                name: 'All Report',
                data: @json($reported_items)
                }],
          chart: {
          width: 380,
          type: 'pie',
